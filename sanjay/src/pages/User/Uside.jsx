      ...
      <div className="w-72 bg-neutral-300 fixed h-full overflow-x-hidden pt-2.5">
        ...
        <div className='mt-4'>
          ...
          <div className="mt-[9rem]">
            ...
            <NavLink to='/alog'>
            <button className="bg-neutral-300 text-black outline-none border-none w-11/12 ml-2.5 rounded-lg h-16 px-5 text-xl font-semibold hover:text-white hover:bg-black">
              <div className="flex items-center">
